...
export const AFFIX_RULES = [
    ...
    { id: 'poison_on_hit',       name: 'Filo envenenado',  icon: '☠️', kind: 'rule', hook: 'onAttack', v: 1,
      desc: 'Al golpear, envenenas ({v} por ronda, se acumula)' },
...
export const AFFIX_UNIQUES = [
    ...
    { id: 'frenzy',           name: 'Frenesí',       icon: '🤯', rarity: 'legendaria', kind: 'rule', hook: 'onAttack', v: 2,
      desc: 'Ataques consecutivos al mismo objetivo hacen ×{v} (se acumula)' },
    { id: 'pyre',             name: 'Pira',          icon: '🔥', rarity: 'legendaria', kind: 'rule', hook: 'onSkill', v: 3,
      desc: 'Golpe de Fuego hace +2 y quema {v} en 3 rondas' },
